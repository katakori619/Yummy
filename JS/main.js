...
$(document).on('input','.contactUs #name',function(){
    ...
    if(!nameregex.test(value)){
        document.querySelector('.contactUs .name').classList.remove('d-none')
        first = false
    }
    else{
        document.querySelector('.contactUs .name').classList.add('d-none')
        first = true
    }
    validate()
})
$(document).on('input','.contactUs #email',function(){
    ...
    if(!emailregex.test(value)){
        document.querySelector('.contactUs .email').classList.remove('d-none')
        second = false
    }
    else{
        document.querySelector('.contactUs .email').classList.add('d-none')
        second = false
    }
    validate()
})
$(document).on('input','.contactUs #phone',function(){
    ...
    if(!phoneregex.test(value)){
        document.querySelector('.contactUs .phone').classList.remove('d-none')
        third = false
    }
    else{
        document.querySelector('.contactUs .phone').classList.add('d-none')
        third = true
    }
    validate()
})
$(document).on('input','.contactUs #age',function(){
    ...
    if(!ageregex.test(value)){
        document.querySelector('.contactUs .age').classList.remove('d-none')
        fourth = false
    }
    else{
        document.querySelector('.contactUs .age').classList.add('d-none')
        fourth = true
    }
    validate()
})
$(document).on('input','.contactUs #pass',function(){
    ...
    if(!passwordregex.test(value)){
        document.querySelector('.contactUs .password').classList.remove('d-none')
        fifth = false
    }
    else{
        document.querySelector('.contactUs .password').classList.add('d-none')
        fifth = true
    }
    validate()
})
$(document).on('input','.contactUs #repass',function(){
    ...
    if(value !== value2){
        document.querySelector('.contactUs .repass').classList.remove('d-none')
        sixth = false
    }
    else{
        document.querySelector('.contactUs .repass').classList.add('d-none')
        sixth = true
    }
    validate()
})
function validate(){
    if(first && second && third && fourth && fifth && sixth){
        document.querySelector('.potato button').classList.remove('disabled')
    }
    else{
        document.querySelector('.potato button').classList.add('disabled')
    }
}
